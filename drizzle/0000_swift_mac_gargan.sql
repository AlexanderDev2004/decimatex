...
CREATE UNIQUE INDEX "criteria_decision_name_uq" ON "criteria" USING btree ("decision_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "criteria_decision_id_uq" ON "criteria" USING btree ("decision_id","id");
